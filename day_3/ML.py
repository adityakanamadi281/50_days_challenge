...
class ToyotaMLRModel:
    ...
    def load_data(self):
        ...
        try:
            ...
            if 'Cylinders' in self.df.columns:
                ...
                print(" 'Cylinders' column not found (already removed or absent).")
    ...
    def save_results(self, results):
        ...
        try:
            result_path = os.path.join(self.save_path, "ML_results.txt")
...
def main():
    ...
    if model.df is not None:
        ...
        if results:
            ...
            print("All tasks completed successfully! Images and text saved beside this script.")
        else:
